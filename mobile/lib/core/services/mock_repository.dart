  ...
  void _initData() {
    ...
    complaints = [
      Complaint(
        id: 'report-001',
        userId: 'user-001',
        title: 'Huge Pothole near Chunkankadai Junction',
        description: 'A deep pothole is blocking traffic near Chunkankadai Junction. It has caused multiple two-wheeler accidents in the past few days.',
        category: 'Roads',
        status: 'IN_PROGRESS',
        priority: 'HIGH',
      ...
      Complaint(
        id: 'report-002',
        userId: 'user-002',
        title: 'Broken Streetlight on Aloor Road',
      ...
      Complaint(
        id: 'report-003',
        userId: 'user-003',
        title: 'Overflowing Sewage Drain near Chunkankadai Pond',
      ...
      Complaint(
        ...
        description: 'Clean drinking water is bursting out of the road pipeline near Villukuri Road. Hundreds of gallons of water are being wasted.',
        category: 'Water',
        status: 'IN_PROGRESS',
        priority: 'MEDIUM',
      ...
      Complaint(
        id: 'report-005',
        userId: 'user-005',
        title: 'Garbage Accumulation near Chunkankadai Bus Stop',
      ...
      Complaint(
        id: 'report-007',
        userId: 'user-007',
        title: 'Broken Benches in Chunkankadai Community Park',
        description: 'Two benches along the community park walking trail are broken and unsafe for senior citizens to sit.',
      ...
      Complaint(
        id: 'report-008',
        userId: 'user-008',
        title: 'Stagnant Water near Chunkankadai Kulam',
      ...
      Complaint(
        ...
        title: 'Severe Road Crack near Chunkankadai Bridge',
        description: 'A structural crack has formed on the road near the bridge. Vehicles get jerked when passing over it. Needs inspection.',
        category: 'Roads',
        status: 'SUBMITTED',
        priority: 'HIGH',
        assignedDepartment: 'Roads Dept',
      ...
      Complaint(
        id: 'report-010',
        userId: 'user-010',
        title: 'Low Water Pressure near Villukuri Road',
    ...
    notifications = [
      UserNotification(
        ...
        title: 'Issue Cleared',
        message: 'Your streetlight complaint on Aloor Road has been resolved successfully.',
        isRead: false,
